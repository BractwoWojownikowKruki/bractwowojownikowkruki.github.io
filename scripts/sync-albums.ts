...
const GENERATED_JSON = join(ROOT, 'public/krucze-galery/data/albums.generated.json');
const COVERS_DIR = join(ROOT, 'public/krucze-galery/covers');
const THUMBS_DIR = join(ROOT, 'public/krucze-galery/thumbs');
